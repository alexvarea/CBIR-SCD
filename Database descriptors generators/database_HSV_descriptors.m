...
descriptors_HSV = zeros(num_images, coefficients);  % Preallocate space for descriptors
...
for img_idx = 0:num_images-1
    ...
    descriptors_HSV(img_idx+1, :) = hist_compressed_I';
end

%Save descriptors for future use
save('descriptors_HSV.mat', 'descriptors_HSV');
%#####################################